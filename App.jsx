...
import GonzoTalkerProdScr from './TaLkErGoNzO/gonzo/GonzoTalkerProdScr';
import IntroSteps from './TaLkErGoNzO/gonzo/IntroSteps';
import Topics from './TaLkErGoNzO/gonzo/Topics';
import TopicFull from './TaLkErGoNzO/gonzo/TopicFull';
import CreateTopic from './TaLkErGoNzO/gonzo/CreateTopic';
import FavoriteTopics from './TaLkErGoNzO/gonzo/FavoriteTopics';
import RecordTalk from './TaLkErGoNzO/gonzo/RecordTalk';
import Records from './TaLkErGoNzO/gonzo/Records';
import Quiz from './TaLkErGoNzO/gonzo/Quiz';
import Settings from './TaLkErGoNzO/gonzo/Settings';
...
const App = () => {
  ...
  OneSignal.initialize('9d6b2e07-40e5-4cfe-b04e-9e6b116f350e');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-06-13T13:00:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="GonzoTalkerProdScr"
            component={GonzoTalkerProdScr}
    ...
    return (
      <Stack.Navigator initialRouteName={"IntroSteps"}>
        <Stack.Screen
          name="IntroSteps"
          component={IntroSteps}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="Topics"
  ...
  //console.log('aceptTransperency==>', aceptTransperency);
  //console.log('completeLink==>', completeLink);
  // || !aceptTransperency || !completeLink
  
  return (
    <NavigationContainer>
      {!louderPrevIsEnded || !aceptTransperency || !completeLink  ? (
        <ImageBackground
          source={require('./TaLkErGoNzO/merch/new/test01.png')}
